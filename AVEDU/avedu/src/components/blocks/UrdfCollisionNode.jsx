...
export default function UrdfCollisionNode({ id, data }) {
  ...
  return (
    <div className="rf-card rf-card--collision" style={{ minWidth: 320 }}>
      <div className="rf-card__title">🛡️ Collision Geometry</div>
      ...
      <div className="rf-card__body" style={{ display: "grid", gap: ".5rem" }}>
        ...
        {geometry.type === "mesh" && (
          <div className="rf-field">
            <label>Collision Mesh File</label>
            <input
              className="rf-input"
              placeholder="package://path/to/collision.stl"
        ...
        <div className="rf-hint" style={{ fontSize: "0.85em", color: "#666", marginTop: ".5rem" }}>
          💡 Collision geometry is typically simpler than visual geometry for better physics performance
        </div>
      </div>
